...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.save_best is True:
            torch.save(save_file, "save_weights/best_obstraction_model.pth")
        else :
            torch.save(save_file, "save_weights/model_obstraction_{}.pth".format(epoch))
...
def parse_args():
    ...
    parser.add_argument("--data-path", default="./data/obstraction/", help="data root")
    # exclude background
